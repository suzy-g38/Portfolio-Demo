...
**Branch: `03-nextjs`.** This branch root is the finished, deploy-ready
version of the portfolio. `starter/` inside this same branch is the
boilerplate students build from during the session.
...
- Open dev tools → Network tab on this page vs. the Stage 2 (React)
  complete version. Notice how much less JS ships here — most of this
